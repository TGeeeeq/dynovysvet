...
export const metadata: Metadata = {
  ...
  description:
    "Prostory Statku u Pipků pro svatby, oslavy a firemní akce. Vybavená restaurace s kuchyňským zázemím, uzavřený dvůr, stodola a zahrada se stylovými atrakcemi.",
};
